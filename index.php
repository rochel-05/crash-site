        ...
        <div class="container_12">
          <div class="grid_12">
            <div class="pad-0 border-1">
                <h2 class="top-1 p0">Votre securité est notre Priorité!</h2>
                <p class="p2">Sous la direction du Directeur Generale de la Securité Routiere <a href="http://les-professionnels-de-madagascar.com/direct-gale-sec-rout/" target="_blank" class="link">, nous vous </a> offrons un moyen performant et pertinent pour optmiser la technique de la securité routiere. Cette technique
                assure votre vie pour un evenement inattendue, fait un alerte pendant un cas echeant et detecte votre immatriculation!</p>
            </div>
